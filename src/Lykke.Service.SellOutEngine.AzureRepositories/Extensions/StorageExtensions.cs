...
namespace Lykke.Service.SellOutEngine.AzureRepositories.Extensions
{
    internal static class StorageExtensions
    {
        public static async Task InsertThrowConflictAsync<T>(this INoSQLTableStorage<T> storage, T entity)
